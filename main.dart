...
void main() {
  // Create LANY songs
  Song song1 = Song('Likey', 'Twice', 240);
  Song song2 = Song('The Feels', 'Twice', 234);
  Song song3 = Song('Feel Special', 'Twice', 221);
  Song song4 = Song('One Spark', 'Twice', 237);
  Song song5 = Song('TT', 'Twice', 194);
  Song song6 = Song('Fancy', 'Twice', 223);
